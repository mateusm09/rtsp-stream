...
#### RTSP_STREAM_THUMB_CACHE_TIME

Default: `1h0m0s`<br/>
Type: string<br/>
Description: Time period for thumbnail caching [Info on format here](https://golang.org/pkg/time/#ParseDuration)<br/>

### RTSP_STREAM_CONFIG_FILE

Default: `rtsp-stream.yml`<br/>
Type: string<br/>
Description: Path to the configuration file that contains the settings for the application. If not set, the application will use the default values above.<br/>
